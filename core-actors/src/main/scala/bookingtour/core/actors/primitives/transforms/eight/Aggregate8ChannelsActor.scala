...
import bookingtour.protocols.actors.aggregators.{Aggregate8Channels, Aggregate8Fn}
...
/**
  ...
  */
final class Aggregate8ChannelsActor[
    Input0,
    Id0,
    Input1,
    Id1,
    ...
    val makeChannel7: MakeSignalChannel,
    val makeChannelState: MakeChannel[Output, OutputId],
    val merge: Aggregate8Channels[
      Input0,
      Input1,
      Input2,
      Input3,
  ...
  override def preStart(): Unit = {
    ...
    val ch7Ref = makeChannel7.make[Id7](context, self, channelTag7, channelId7)
    val ch7 = SignalChannelCreated(
    ...
    basicBehavior(
      ...
      ch7 = ch7,
      ch7Status = ChannelStatus.Undefined,
      state = state,
      arrowRun = false,
      needDrain = false
    )
...
object Aggregate8ChannelsActor {
  final def make[
      Input0,
      Id0,
      Input1,
      ...
      makeChannel7: MakeSignalChannel,
      ...
      mergeFn: Aggregate8Fn[Input0, Input1, Input2, Input3, Input4, Input5, Input6, Input7, Output],
        ...
        .actorOf(
          Props(
            new Aggregate8ChannelsActor(
              ...
              makeChannel7 = makeChannel7,
              makeChannelState = makeChannelState,
              merge = Aggregate8Channels
                .make[
                  Input0,
                  Input1,
                  Input2,
