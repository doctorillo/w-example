...
import bookingtour.protocols.actors.aggregators.{Aggregate6Channels, Aggregate6Fn}
...
/**
  ...
  */
final class Aggregate6ChannelsActor[
    Input0,
    Id0,
    Input1,
    Id1,
    ...
    val merge: Aggregate6Channels[Input0, Input1, Input2, Input3, Input4, Input5, Output],
...
object Aggregate6ChannelsActor {
  final def make[
      Input0,
      Id0,
      Input1,
      ...
      mergeFn: Aggregate6Fn[Input0, Input1, Input2, Input3, Input4, Input5, Output],
      ...
      .actorOf(
        Props(
          new Aggregate6ChannelsActor(
            ...
            merge = Aggregate6Channels
              .make[Input0, Input1, Input2, Input3, Input4, Input5, Output, OutputId],
